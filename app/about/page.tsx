      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6">
            <h3 className={`text-2xl font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>
              Career Highlights
            </h3>
            <div className={`space-y-4 leading-relaxed ${darkMode ? 'text-gray-400' : 'text-gray-700'}`}>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="glass-card p-6 rounded-xl group bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className={`font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>Clean Code</h4>
                </div>
                <p className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} text-sm leading-relaxed`}>
              ...
              <div className="glass-card p-6 rounded-xl group bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className={`font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>Innovation</h4>
                </div>
                <p className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} text-sm leading-relaxed`}>
              ...
              <div className="glass-card p-6 rounded-xl group bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className={`font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>Collaboration</h4>
                </div>
                <p className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} text-sm leading-relaxed`}>
              ...
              <div className="glass-card p-6 rounded-xl group bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className={`font-semibold ${darkMode ? 'text-gray-300' : 'text-gray-800'}`}>Performance</h4>
                </div>
                <p className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} text-sm leading-relaxed`}>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center glass-card p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
            ...
            <div className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} font-medium`}>Major Systems Built</div>
          </div>
          ...
          <div className="text-center glass-card p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
            ...
            <div className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} font-medium`}>Years Experience</div>
          </div>
          ...
          <div className="text-center glass-card p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-md hover:shadow-lg transition-shadow duration-300 hover:scale-105 transform">
            ...
            <div className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} font-medium`}>Technologies & Tools Used</div>
          </div>
