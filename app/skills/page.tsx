...
//         desc: "Server-side React framework",
//       },
//       {
//         name: "Node.js",
...
//         desc: "Open-source backend with PostgreSQL, APIs, auth, and storage",
//       },
//     ],
//   },
//   {
...
//           >
//             <h3
//               className={`${darkMode ? "text-gray-300" : "text-gray-800"} md:text-lg font-semibold mb-4`}
//             >
//               {group.category}
//             </h3>
...
//                       <span
//                         className={`${darkMode ? "text-gray-300" : "text-gray-800"} font-medium text-sm`}
//                       >
//                         {skill.name}
//                       </span>
//                       <span
//                         className={`${darkMode ? "text-gray-400" : "text-gray-600"} text-xs truncate`}
//                       >
//                         {skill.desc}
//                       </span>
//                     </div>
